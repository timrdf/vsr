...
<xsl:variable name="vsr:SPODataset"                      select="concat($vsr,'SPODataset')"/>
...
<xsl:variable name="vsr:SourcePredicatesDataset"         select="concat($vsr,'SourcePredicatesDataset')"/>
<xsl:variable name="vsr:BridgePredicatesDataset"         select="concat($vsr,'BridgePredicatesDataset')"/>
<xsl:variable name="vsr:SinkPredicatesDataset"           select="concat($vsr,'SinkPredicatesDataset')"/>
